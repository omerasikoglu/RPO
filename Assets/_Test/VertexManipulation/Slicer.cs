...
namespace VertexManipulation {
    public class Slicer {
        ...
        public static GameObject[] Slice(Plane plane, GameObject objectToCut) {
            ...
            SlicesMetadata slicesMeta = new SlicesMetadata(plane, mesh, sliceable.isSolid, sliceable.isReverseWindTriangles, sliceable.IsSharingVertices, sliceable.IsSmoothVertices);
            ...
            SetupCollidersAndRigidBodys(ref positiveObject, positiveSideMeshData, sliceable.isUsingGravity);
            SetupCollidersAndRigidBodys(ref negativeObject, negativeSideMeshData, sliceable.isUsingGravity);
        ...
        private static GameObject CreateMeshGameObject(GameObject originalObject) {
            ...
            sliceable.isReverseWindTriangles = originalSliceable.isReverseWindTriangles;
            sliceable.isUsingGravity = originalSliceable.isUsingGravity;
